...
def main():
    ...
    model = UNET(3,64,1,padding=0, downhills=4).to(DEVICE)
    ...
    train_loader, val_loader = get_loaders(db_root_dir=ROOT_DIR, batch_size=8, 
                                           train_transform=train_transform, val_transform=val_transforms, num_workers=4)
